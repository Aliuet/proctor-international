  ...
  <section id="hero">
    ...
    <div class="container">
      ...
      <div class=" col-lg-6 py-5 py-lg-0 order-2 order-lg-1" data-aos="fade-right">
        <h1>IT Consulting</h1>
        <h2>we provide comprehensive solutions to optimize and streamline your technology infrastructure, ensuring your business operates at peak efficiency. </h2>
    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p data-aos="fade-in">we provide comprehensive solutions to optimize and streamline your technology infrastructure, ensuring your business operates at peak efficiency. </p>
        </div>
        ...
        <div class="col-md-6 d-flex" data-aos="fade-right">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="">Technology Assessment</a></h5>
                <p class="card-text">Evaluating your existing IT setup to identify strengths, weaknesses, and opportunities for improvement.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 d-flex" data-aos="fade-left">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text"> Implementing robust security measures to safeguard your data and systems from cyber threats.</p>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex" data-aos="fade-right">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/it-consulting/cloud.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Cloud Solutions</a></h5>
                <p class="card-text">Migrating your operations to cloud platforms for enhanced scalability and cost-effectiveness.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 d-flex" data-aos="fade-left">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="">IT Strategy & Planning</a></h5>
                <p class="card-text">Developing custom IT strategies aligned with your business goals and growth objectives.</p>
          ...
          <div class="col-md-6 d-flex" data-aos="fade-right">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/it-consulting/infra.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">IT Infrastructure Management</a></h5>
                <p class="card-text">Managing and maintaining your hardware, software, and network infrastructure.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 d-flex" data-aos="fade-left">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/it-consulting/plan.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Business Continuity Planning</a></h5>
                <p class="card-text">Creating disaster recovery and backup solutions to ensure seamless operations.</p>
                <div class="read-more"><a href="#"><i class="bi bi-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up">
          <div class="col-lg-5">
            ...
            <h4>Why do businesses need IT Consulting services?</h4>
          </div>
          <div class="col-lg-7">
            <p>
            IT Consulting services assist businesses in making informed technology decisions, ensuring efficiency, security, and scalability, which are crucial for staying competitive in the digital landscape.
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
        ...
        <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-5">
            <i class="bx bx-help-circle"></i>
            <h4>What areas does IT Consulting cover?</h4>
          </div>
          <div class="col-lg-7">
            <p>
            IT Consulting covers various areas, including network infrastructure, cybersecurity, cloud computing, software solutions, data management, and IT strategy planning.
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
        ...
        <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-5">
            <i class="bx bx-help-circle"></i>
            <h4>How can IT Consulting improve cybersecurity for my business?</h4>
          </div>
          <div class="col-lg-7">
            <p>
            IT Consulting assesses your current security measures, identifies vulnerabilities, and implements robust security protocols to protect your data and systems from cyber threats.
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
        ...
        <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
          <div class="col-lg-5">
            <i class="bx bx-help-circle"></i>
            <h4>What are the benefits of migrating to the cloud with IT Consulting?</h4>
          </div>
          <div class="col-lg-7">
            <p>
            IT Consulting can facilitate a smooth migration to the cloud, offering benefits such as increased scalability, cost-efficiency, remote accessibility, and data backup.
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
        ...
        <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
          <div class="col-lg-5">
            <i class="bx bx-help-circle"></i>
            <h4>Can IT Consulting help optimize my existing IT infrastructure?</h4>
          </div>
          <div class="col-lg-7">
            <p>
            Yes, IT Consulting provides insights into optimizing your IT infrastructure, streamlining processes, and utilizing technology more effectively to improve overall performance.
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
        ...
        <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
          <div class="col-lg-5">
            <i class="bx bx-help-circle"></i>
            <h4>How can IT Consulting support disaster recovery planning?</h4>
          </div>
          <div class="col-lg-7">
            <p>
            IT Consulting assists in creating comprehensive disaster recovery plans, ensuring data backups, and implementing recovery strategies to minimize downtime during unforeseen events.
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
